...
public class SecretProofTransactionBuilder {
    ...
    public static SecretProofTransactionBuilder loadFromBinary(DataInput stream) throws Exception {
        SecretProofTransactionBuilder obj = new SecretProofTransactionBuilder();
