...
public class AddressPropertyTransactionBuilder {
    public int getSize()  {
        return this.size;
    }
    ...
    public static AddressPropertyTransactionBuilder loadFromBinary(DataInput stream) throws Exception {
        AddressPropertyTransactionBuilder obj = new AddressPropertyTransactionBuilder();
