...
public class BlockInfo {
	...
	private final List<String> transactionHash;
	...
	private BlockInfo(String hash, String generationHash, BigInteger totalFee, Integer numTransactions, List<String> transactionHash,
					  String signature,
	...
	public static BlockInfo create(String hash, String generationHash, BigInteger totalFee, Integer numTransactions,
		...
		return new BlockInfo(hash, generationHash, totalFee, numTransactions, transactionHas, signature, signerPublicAccount, networkType,
