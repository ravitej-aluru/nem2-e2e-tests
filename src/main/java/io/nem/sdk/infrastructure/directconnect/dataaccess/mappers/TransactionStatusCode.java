...
public enum TransactionStatusCode {
  ...
  FAILURE_RESTRICTIONACCOUNT_INVALID_RESTRICTION_TYPE(0x80500001),
  ...
  FAILURE_RESTRICTIONACCOUNT_MODIFICATION_REDUNDANT(0x80500005),
  ...
  FAILURE_RESTRICTIONACCOUNT_VALUES_COUNT_EXCEEDED(0x80500008),
  FAILURE_RESTRICTIONACCOUNT_INVALID_VALUE(0x80500009),
  FAILURE_RESTRICTIONACCOUNT_ADDRESS_INTERACTION_PROHIBITED(0x8050000A),
  FAILURE_RESTRICTIONACCOUNT_MOSAIC_TRANSFER_PROHIBITED(0x8050000B),
  FAILURE_RESTRICTIONACCOUNT_OPERATION_TYPE_PROHIBITED(0x8050000C),
