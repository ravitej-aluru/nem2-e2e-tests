...
public enum TransactionStatusCode {
  ...
  FAILURE_HASH_LOCK_ALREADY_HASH_EXISTS(0X80480003),
  ...
  FAILURE_SECRET_LOCK_ALREADY_HASH_EXISTS(0X80520002),
  FAILURE_SECRET_LOCK_PROOF_SIZE_OUT_OF_BOUNDS(0X80520003),
  FAILURE_SECRET_LOCK_SECRET_MISMATCH(0X80520004),
  FAILURE_SECRET_LOCK_UNKNOWN_COMPOSITE_KEY(0X80520005),
  FAILURE_SECRET_LOCK_INACTIVE_SECRET(0X80520006),
  FAILURE_SECRET_LOCK_HASH_ALGORITHM_MISMATCH(0X80520007),
  FAILURE_SECRET_LOCK_INVALID_DURATION(0X80520008),
