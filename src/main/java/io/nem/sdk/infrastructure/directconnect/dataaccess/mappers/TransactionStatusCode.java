...
public enum TransactionStatusCode {
	...
	FAILURE_HASH_LOCK__INVALID_MOSAIC_ID(0X80480001),
	FAILURE_HASH_LOCK__INVALID_MOSAIC_AMOUNT(0X80480002),
	FAILURE_HASH_LOCK__HASH_EXISTS(0X80480003),
	FAILURE_HASH_LOCK__HASH_DOES_NOT_EXIST(0X80480004),
