...
public class MosaicMetadataHelper {
    ...
    private MosaicMetadataTransaction createMosaicMetadataTransaction(
        ...
        final String value) {
        final MosaicMetadataTransactionFactory mosaicMetadataTransactionFactory = MosaicMetadataTransactionFactory
            .create(
        ...
        return CommonHelper
            .appendCommonPropertiesAndBuildTransaction(mosaicMetadataTransactionFactory, deadline,
                maxFee);
    }
