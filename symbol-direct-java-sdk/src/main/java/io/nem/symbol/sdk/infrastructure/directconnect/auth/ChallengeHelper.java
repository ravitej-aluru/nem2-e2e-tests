...
import io.nem.symbol.core.crypto.*;
...
public class ChallengeHelper {
  ...
  static ByteBuffer generateServerChallengeResponse(
    ...
    final DsaSigner signer = CryptoEngines.defaultEngine().createDsaSigner(keyPair);
  ...
  static boolean verifyClientChallengeResponse(
    ...
    final DsaSigner signer = CryptoEngines.defaultEngine().createDsaSigner(serverKeyPair);
