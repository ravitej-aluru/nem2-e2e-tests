...
/** Search interface for the transaction collection */
public interface SearchableTransactionCollection {
  /**
   ...
   */
  Optional<Transaction> getTransaction(final String transactionHash);
   ...
   */
  List<Transaction> getTransactions(final List<String> transactionHashes);
   ...
   */
  List<Transaction> search(final TransactionSearchCriteria criteria);
}
