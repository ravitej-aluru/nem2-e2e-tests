...
public class MosaicHelper {
  ...
  private MosaicDefinitionTransaction createExpiringMosaicDefinitionTransaction(
    ...
    return CommonHelper.appendCommonPropertiesAndBuildTransaction(
        mosaicDefinitionTransactionFactory, deadline, maxFee);
  }
  ...
  private MosaicDefinitionTransaction createMosaicDefinitionTransaction(
    ...
    final MosaicDefinitionTransactionFactory mosaicDefinitionTransactionFactory =
        MosaicDefinitionTransactionFactory.create(
            ...
            mosaicFlags,
            divisibility,
            new BlockDuration(BigInteger.ZERO));
    return CommonHelper.appendCommonPropertiesAndBuildTransaction(
        mosaicDefinitionTransactionFactory, deadline, maxFee);
  }
  ...
  private MosaicSupplyChangeTransaction createMosaicSupplyChangeTransaction(
    ...
    final MosaicSupplyChangeTransactionFactory mosaicSupplyChangeTransactionFactory =
        MosaicSupplyChangeTransactionFactory.create(
            testContext.getNetworkType(), mosaicId, mosaicSupplyChangeActionType, delta);
    return CommonHelper.appendCommonPropertiesAndBuildTransaction(
        mosaicSupplyChangeTransactionFactory, deadline, maxFee);
  }

  public MosaicSupplyChangeTransaction createMosaicSupplyChangeTransaction(
      final MosaicId mosaicId,
      MosaicSupplyChangeActionType mosaicSupplyChangeActionType,
      BigInteger delta) {
  ...
  public SignedTransaction createMosaicDefinitionTransactionAndAnnounce(
    ...
    return transactionHelper.signAndAnnounceTransaction(
        account, () -> createMosaicDefinitionTransaction(account, mosaicFlags, divisibility));
  }
  ...
  public Mosaic getMosaicFromNamespace(final NamespaceId namespaceId, final BigInteger amount) {
    if (!testContext.getNetworkCurrency().getNamespaceId().get().getId().equals(namespaceId.getId())) {
    ...
    final BigInteger actualAmount = testContext.getNetworkCurrency().createRelative(amount).getAmount();
