...
public class SendAsset extends BaseTest {
  ...
  public void verifyRecipientAsset(
    ...
    final MosaicId mosaicId = resolveMosaicId(assetName);
    final long actualAmount =
        getActualMosaicQuantity(getNamespaceIdFromName(assetName), BigInteger.valueOf(amount))
            .longValue();
    ...
    assertEquals(
        errorMessage, actualAmount, mosaicAfter.get().getAmount().longValue() - initialAmount);
  }
